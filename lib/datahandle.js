...
// =======================================================
	...
	// 該当するフィールドのみの新しいObjectArrayを生成する
	dataHandle.ObjectArray.prototype.filterColumn = function(reserveLabels){
		// フィールドは配列で渡されなくてはならない
		if (!Array.isArray(reserveLabels))return;
		...
		tempData = this.data.map(function(element, index, array){
			...
			// 元要素の指定されたフィールドだけ新しい行に追加していく
			reserveLabels.forEach(function(key){
